...
```bash
git clone --branch v1.3.4 --depth 1 https://github.com/bluetape4k/bluetape-skills.git
cd bluetape-skills
./scripts/validate.sh
./scripts/install.sh
```
...
```bash
git clone --branch v1.3.4 --depth 1 https://github.com/bluetape4k/bluetape-skills.git bluetape-skills-v1.3.4
cd bluetape-skills-v1.3.4
./scripts/validate.sh
./scripts/install.sh --force
```
