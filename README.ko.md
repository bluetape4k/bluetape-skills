...
아직 릴리스되지 않은 변경까지 따라가려면 `--branch v1.0.0 --depth 1` 옵션을 빼고 `main`을 복제하세요. 공개 버전과 다운로드 가능한 묶음은 [GitHub Releases](https://github.com/bluetape4k/bluetape-skills/releases)에서 확인할 수 있습니다.
...
복제하거나 갱신한 뒤 `./scripts/validate.sh`를 실행하세요. canonical inventory, 필수 front matter, private/runtime payload 부재를 검사합니다.
